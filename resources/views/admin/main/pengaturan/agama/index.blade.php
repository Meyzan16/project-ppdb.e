...
<div id="main-content">
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header text-right">
                        ...
                        <a href="{{ route('admin.data-agama.trash') }}" class='sidebar-link'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('data-agama.destroy', $item->id) }}" method="POST" class="d-inline">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('data-agama.store') }}" method="POST">
                @csrf 
    ...
    <div class="modal fade" id="edit_data{{ $item1->id  }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('data-agama.update', $item1->id) }}" method="POST">
                    @csrf  @method('put')
                    <div class="modal-body">
                        <h6 class="modal-title" id="exampleModalCenterTitle"> Nama  </h6>
